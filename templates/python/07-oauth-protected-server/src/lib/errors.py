...
See ``06-rag-knowledge-server/src/lib/errors.py`` for the full design
rationale. Tools raise :class:`ToolError` to produce MCP ``isError``
responses; ``success``/``failure`` build content lists for manual use
and tests.
"""
